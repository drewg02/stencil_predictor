...
train_loader, val_loader, test_loader, processed_img_area, img_height, img_width = tut.prepare_data_split(
    input_file_path, batch_size, seq_length, train_ratio=0.7, val_ratio=0.15)

...
def main(args):
    # Argument parsing
    parser = ut.ArgParser(description='Generate an array with a plus')
    ...
    parser.add_argument('--thickness', type=int, help='Thickness of the plus', default=1)
    ...
    array = ut.create_plus_array(parsed_args.rows, parsed_args.cols, parsed_args.thickness, input_array)

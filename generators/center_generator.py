...
def main(args):
    # Argument parsing
    parser = ut.ArgParser(description='Generate an array with a center')
    ...
    parser.add_argument('--thickness', type=int, help='Thickness of the center', default=1)
    ...
    array, mask = ut.create_array(parsed_args.rows, parsed_args.cols, ut.ArrayType.CENTER, parsed_args.thickness, input_array, input_mask)
